...
<body class="bg-argon-light font-sans antialiased m-0 p-0 relative overflow-x-hidden min-h-screen flex flex-col">
    ...
    <div
        class="absolute top-0 w-full h-96 bg-gradient-to-r from-argon-indigo to-argon-blue transform -skew-y-6 origin-top-left -z-10 shadow-lg">
    </div>
            ...
            <div class="px-8 pb-8">
                <form method="POST" action="{{ route('admin.login.submit') }}">
                    ...
                    <div class="flex items-center justify-between mb-6 mt-2">
                        <label class="flex items-center cursor-pointer">
                            <input type="checkbox" name="remember"
                                class="w-4 h-4 text-argon-blue bg-white border-slate-300 rounded focus:ring-argon-blue focus:ring-2 cursor-pointer transition duration-200">
                            <span class="ml-2 text-sm text-slate-600 font-medium">Ingat saya</span>
                        </label>

                        <a href="#"
                            class="text-sm text-argon-blue hover:text-argon-indigo font-semibold transition-colors">
                            Lupa password?
                        </a>
                    </div>
                    ...
                    <div class="text-center">
                        <button type="submit"
                            class="w-full bg-argon-blue hover:bg-argon-indigo text-white font-bold py-3 px-4 rounded-lg shadow-md hover:shadow-lg hover:-translate-y-px transition-all duration-300 text-sm tracking-wide">
                            MASUK
                        </button>
                    </div>
                </form>
